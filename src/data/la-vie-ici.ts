...
const en: LaVieIciStrings = {
  ...
  openingLead: 'Toile Blanche is not only a place to stay.',
  openingParagraphs: ['What follows is the rest of it.'],
  familyParagraphs: [
...
const fr: LaVieIciStrings = {
  ...
  openingLead: 'Toile Blanche n\u2019est pas seulement un lieu où séjourner.',
  openingParagraphs: ['Ce qui suit, c\u2019est le reste.'],
  familyParagraphs: [
    'Depuis près de deux siècles, le mas où tout a commencé est là, ancré à Saint-Paul-de-Vence.',
    'En 1999, la famille Leroy le découvrent. Ils ne cherchent pas à le transformer, mais à révéler ce qu\u2019il est déjà. Trois chambres s\u2019ouvrent, simplement. Une maison, avant tout.',
